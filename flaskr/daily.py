...
@bp.route('/lineup')
def lineup():
    df = getLineups(str(date.today()), 'names')
    #df = getLineups('2021-03-19', 'names')
    return render_template('daily/lineups.html', tables=[df.to_html(classes='data')], titles=df.columns.values)
